...
pub struct Invoice {
    ...
    #[serde(
        rename = "cbc:ProfileExecutionID",
        alias = "ProfileExecutionID",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "cbc:InvoiceTypeCode",
        alias = "InvoiceTypeCode",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "cbc:DocumentCurrencyCode",
        alias = "DocumentCurrencyCode",
        skip_serializing_if = "Option::is_none"
    )]
    pub document_currency_code: Option<Code>,

    #[serde(
        rename = "cbc:TaxCurrencyCode",
        alias = "TaxCurrencyCode",
        skip_serializing_if = "Option::is_none"
    )]
    pub tax_currency_code: Option<Code>,

    #[serde(
        rename = "cbc:PricingCurrencyCode",
        alias = "PricingCurrencyCode",
        skip_serializing_if = "Option::is_none"
    )]
    pub pricing_currency_code: Option<Code>,

    #[serde(
        rename = "cbc:PaymentCurrencyCode",
        alias = "PaymentCurrencyCode",
        skip_serializing_if = "Option::is_none"
    )]
    pub payment_currency_code: Option<Code>,

    #[serde(
        rename = "cbc:PaymentAlternativeCurrencyCode",
        alias = "PaymentAlternativeCurrencyCode",
        skip_serializing_if = "Option::is_none"
    )]
    pub payment_alternative_currency_code: Option<Code>,

    #[serde(
        rename = "cbc:AccountingCostCode",
        alias = "AccountingCostCode",
        skip_serializing_if = "Option::is_none"
    )]
    pub accounting_cost_code: Option<String>,

    #[serde(
        rename = "cbc:AccountingCost",
        alias = "AccountingCost",
        skip_serializing_if = "Option::is_none"
    )]
    pub accounting_cost: Option<String>,

    #[serde(
        rename = "cbc:LineCountNumeric",
        alias = "LineCountNumeric",
        skip_serializing_if = "Option::is_none"
    )]
    pub line_count_numeric: Option<i32>,

    #[serde(
        rename = "cbc:BuyerReference",
        alias = "BuyerReference",
        skip_serializing_if = "Option::is_none"
    )]
    pub buyer_reference: Option<String>,

    #[serde(
        rename = "cac:InvoicePeriod",
        alias = "InvoicePeriod",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "cac:BillingReference",
        alias = "BillingReference",
        skip_serializing_if = "Option::is_none"
    )]
    pub billing_reference: Option<Vec<BillingReference>>,

    #[serde(
        rename = "cac:DespatchDocumentReference",
        alias = "DespatchDocumentReference",
        skip_serializing_if = "Option::is_none"
    )]
    pub despatch_document_reference: Option<Vec<DocumentReference>>,

    #[serde(
        rename = "cac:ReceiptDocumentReference",
        alias = "ReceiptDocumentReference",
        skip_serializing_if = "Option::is_none"
    )]
    pub receipt_document_reference: Option<Vec<DocumentReference>>,

    #[serde(
        rename = "cac:StatementDocumentReference",
        alias = "StatementDocumentReference",
        skip_serializing_if = "Option::is_none"
    )]
    pub statement_document_reference: Option<Vec<DocumentReference>>,

    #[serde(
        rename = "cac:OriginatorDocumentReference",
        alias = "OriginatorDocumentReference",
        skip_serializing_if = "Option::is_none"
    )]
    pub originator_document_reference: Option<Vec<DocumentReference>>,

    #[serde(
        rename = "cac:ContractDocumentReference",
        alias = "ContractDocumentReference",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "cac:AccountingSupplierParty",
        alias = "AccountingSupplierParty"
    )]
    pub accounting_supplier_party: Option<PartyWrapper>,

    #[serde(
        rename = "cac:AccountingCustomerParty",
        alias = "AccountingCustomerParty"
    )]
    pub accounting_customer_party: Option<PartyWrapper>,

    #[serde(
        rename = "cac:PayeeParty",
        alias = "PayeeParty",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "cac:BuyerCustomerParty",
        alias = "BuyerCustomerParty",
        skip_serializing_if = "Option::is_none"
    )]
    pub buyer_customer_party: Option<PartyType>,

    #[serde(
        rename = "cac:SellerSupplierParty",
        alias = "SellerSupplierParty",
        skip_serializing_if = "Option::is_none"
    )]
    pub seller_supplier_party: Option<PartyType>,

    #[serde(
        rename = "cac:TaxRepresentativeParty",
        alias = "TaxRepresentativeParty",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "cac:PrepaidPayment",
        alias = "PrepaidPayment",
        skip_serializing_if = "Option::is_none"
    )]
    pub prepaid_payment: Option<Vec<Payment>>,

    #[serde(
        rename = "cac:AllowanceCharge",
        alias = "AllowanceCharge",
        skip_serializing_if = "Option::is_none"
    )]
    pub allowance_charge: Option<Vec<AllowanceCharge>>,

    #[serde(
        rename = "cac:TaxExchangeRate",
        alias = "TaxExchangeRate",
        skip_serializing_if = "Option::is_none"
    )]
    pub tax_exchange_rate: Option<ExchangeRate>,

    #[serde(
        rename = "cac:PricingExchangeRate",
        alias = "PricingExchangeRate",
        skip_serializing_if = "Option::is_none"
    )]
    pub pricing_exchange_rate: Option<ExchangeRate>,

    #[serde(
        rename = "cac:PaymentExchangeRate",
        alias = "PaymentExchangeRate",
        skip_serializing_if = "Option::is_none"
    )]
    pub payment_exchange_rate: Option<ExchangeRate>,

    #[serde(
        rename = "cac:PaymentAlternativeExchangeRate",
        alias = "PaymentAlternativeExchangeRate",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "cac:WithholdingTaxTotal",
        alias = "WithholdingTaxTotal",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct Period {
    #[serde(
        rename = "cbc:StartDate",
        alias = "StartDate",
        skip_serializing_if = "Option::is_none"
    )]
    pub start_date: Option<String>,
    #[serde(
        rename = "cbc:StartTime",
        alias = "StartTime",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "cbc:DurationMeasure",
        alias = "DurationMeasure",
        skip_serializing_if = "Option::is_none"
    )]
    pub duration_measure: Option<String>,
    #[serde(
        rename = "cbc:DescriptionCode",
        alias = "DescriptionCode",
        skip_serializing_if = "Option::is_none"
    )]
    pub description_code: Option<Vec<String>>,
    #[serde(
        rename = "cbc:Description",
        alias = "Description",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct PartyType {
    #[serde(
        rename = "cbc:EndpointID",
        alias = "EndpointID",
        skip_serializing_if = "Option::is_none"
    )]
    pub endpoint_id: Option<Identifier>,
    #[serde(
        rename = "cac:PartyIdentification",
        alias = "PartyIdentification",
        skip_serializing_if = "Option::is_none"
    )]
    pub party_identification: Option<Vec<PartyIdentification>>,
    #[serde(
        rename = "cac:PartyName",
        alias = "PartyName",
        skip_serializing_if = "Option::is_none"
    )]
    pub party_name: Option<Vec<PartyName>>,
    #[serde(
        rename = "cac:PostalAddress",
        alias = "PostalAddress",
        skip_serializing_if = "Option::is_none"
    )]
    pub postal_address: Option<PostalAddress>,
    #[serde(
        rename = "cac:PartyTaxScheme",
        alias = "PartyTaxScheme",
        skip_serializing_if = "Option::is_none"
    )]
    pub party_tax_scheme: Option<Vec<PartyTaxScheme>>,
    #[serde(
        rename = "cac:PartyLegalEntity",
        alias = "PartyLegalEntity",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct PostalAddress {
    ...
    pub id: Option<Identifier>,
    #[serde(
        rename = "cbc:StreetName",
        alias = "StreetName",
        skip_serializing_if = "Option::is_none"
    )]
    pub street_name: Option<String>,
    #[serde(
        rename = "cbc:AdditionalStreetName",
        alias = "AdditionalStreetName",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct PartyLegalEntity {
    ...
    pub company_id: Option<Identifier>,
    #[serde(
        rename = "cbc:CompanyLegalForm",
        alias = "CompanyLegalForm",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct Contact {
    ...
    pub name: Option<String>,
    #[serde(
        rename = "cbc:Telephone",
        alias = "Telephone",
        skip_serializing_if = "Option::is_none"
    )]
    pub telephone: Option<String>,
    #[serde(
        rename = "cbc:ElectronicMail",
        alias = "ElectronicMail",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct AllowanceCharge {
    #[serde(
        rename = "cbc:ChargeIndicator",
        alias = "ChargeIndicator",
        skip_serializing_if = "Option::is_none"
    )]
    pub charge_indicator: Option<bool>,
    #[serde(
        rename = "cbc:AllowanceChargeReasonCode",
        alias = "AllowanceChargeReasonCode",
        skip_serializing_if = "Option::is_none"
    )]
    pub allowance_charge_reason_code: Option<String>,
    #[serde(
        rename = "cbc:AllowanceChargeReason",
        alias = "AllowanceChargeReason",
        skip_serializing_if = "Option::is_none"
    )]
    pub allowance_charge_reason: Option<String>,
    #[serde(
        rename = "cbc:MultiplierFactorNumeric",
        alias = "MultiplierFactorNumeric",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "cbc:BaseAmount",
        alias = "BaseAmount",
        skip_serializing_if = "Option::is_none"
    )]
    pub base_amount: Option<Amount>,
    #[serde(
        rename = "cac:TaxCategory",
        alias = "TaxCategory",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct TaxTotal {
    #[serde(
        rename = "cbc:TaxAmount",
        alias = "TaxAmount",
        skip_serializing_if = "Option::is_none"
    )]
    pub tax_amount: Option<Amount>,
    #[serde(
        rename = "cbc:TaxInclusiveAmount",
        alias = "TaxInclusiveAmount",
        skip_serializing_if = "Option::is_none"
    )]
    pub tax_inclusive_amount: Option<Amount>,
    #[serde(
        rename = "cac:TaxSubtotal",
        alias = "TaxSubtotal",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct TaxCategory {
    ...
    #[serde(
        rename = "cbc:TaxExemptionReasonCode",
        alias = "TaxExemptionReasonCode",
        skip_serializing_if = "Option::is_none"
    )]
    pub tax_exemption_reason_code: Option<Code>,
    #[serde(
        rename = "cbc:TaxExemptionReason",
        alias = "TaxExemptionReason",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct MonetaryTotal {
    #[serde(
        rename = "cbc:LineExtensionAmount",
        alias = "LineExtensionAmount",
        skip_serializing_if = "Option::is_none"
    )]
    pub line_extension_amount: Option<Amount>,
    #[serde(
        rename = "cbc:TaxExclusiveAmount",
        alias = "TaxExclusiveAmount",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct InvoiceLine {
    ...
    pub note: Option<Vec<TextType>>,
    #[serde(
        rename = "cbc:InvoicedQuantity",
        alias = "InvoicedQuantity",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    pub line_extension_amount: Option<Amount>,
    #[serde(
        rename = "cbc:LineExtensionGrossAmount",
        alias = "LineExtensionGrossAmount",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "cac:SubInvoiceLine",
        alias = "SubInvoiceLine",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct Item {
    ...
    pub name: Option<String>,
    #[serde(
        rename = "cac:BuyersItemIdentification",
        alias = "BuyersItemIdentification",
        skip_serializing_if = "Option::is_none"
    )]
    pub buyers_item_identification: Option<ItemIdentification>,
    #[serde(
        rename = "cac:SellersItemIdentification",
        alias = "SellersItemIdentification",
        skip_serializing_if = "Option::is_none"
    )]
    pub sellers_item_identification: Option<ItemIdentification>,
    #[serde(
        rename = "cac:StandardItemIdentification",
        alias = "StandardItemIdentification",
        skip_serializing_if = "Option::is_none"
    )]
    pub standard_item_identification: Option<ItemIdentification>,
    #[serde(
        rename = "cac:OriginCountry",
        alias = "OriginCountry",
        skip_serializing_if = "Option::is_none"
    )]
    pub origin_country: Option<Country>,
    #[serde(
        rename = "cac:CommodityClassification",
        alias = "CommodityClassification",
        skip_serializing_if = "Option::is_none"
    )]
    pub commodity_classification: Option<Vec<CommodityClassification>>,
    #[serde(
        rename = "cac:ClassifiedTaxCategory",
        alias = "ClassifiedTaxCategory",
        skip_serializing_if = "Option::is_none"
    )]
    pub classified_tax_category: Option<Vec<ClassifiedTaxCategory>>,
    #[serde(
        rename = "cac:AdditionalItemProperty",
        alias = "AdditionalItemProperty",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct Price {
    #[serde(
        rename = "cbc:PriceAmount",
        alias = "PriceAmount",
        skip_serializing_if = "Option::is_none"
    )]
    pub price_amount: Option<Amount>,
    #[serde(
        rename = "cbc:GrossPriceAmount",
        alias = "GrossPriceAmount",
        skip_serializing_if = "Option::is_none"
    )]
    pub gross_price_amount: Option<Amount>,
    #[serde(
        rename = "cbc:BaseQuantity",
        alias = "BaseQuantity",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct CommodityClassification {
    #[serde(
        rename = "cbc:ItemClassificationCode",
        alias = "ItemClassificationCode",
        skip_serializing_if = "Option::is_none"
    )]
